/*
  ...
  Description: Demonstates reading from the public weathre channel which doesn't not require an API key.
               The values read from the public channel are the current weather conditions at MathWorks headquaters in Natick, MA.
